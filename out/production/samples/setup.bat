...
rem ## 
rem ##
rem ## Copyright (c) 2001-2018 by TIBCO Software Inc.
rem ## ALL RIGHTS RESERVED
rem ##
rem ## $Id: setup.bat 102526 2018-07-20 21:27:08Z $
rem ##
...
set CLASSPATH=%TIBEMS_JAVA%\jmsrvjms.jar;%CLASSPATH%
set CLASSPATH=.;%TIBEMS_JAVA%\tibjms.jar;%TIBEMS_JAVA%\tibjmsadmin.jar;%CLASSPATH%
REM set CLASSPATH=%TIBEMS_JAVA%\tibjmsufo.jar;%CLASSPATH%
